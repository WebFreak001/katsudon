    ...
    public partial class ArgonInputDrum : AspectContainer
    {
        ...
        private void load()
        {
            InternalChild = new Container
            {
                ...
                Children = new[]
                {
                    MakeSingle(Anchor.TopCentre, 0),
                    MakeSingle(Anchor.BottomCentre, 1),
                }
            };
        }

        private Container MakeSingle(Anchor anchor, int player)
        {
            ...
            return new Container
            {
                ...
                {
                    new KatsudonHalfDrum(false)
                    {
                        Name = "Left Half",
                        Anchor = Anchor.Centre,
                        Origin = Anchor.CentreRight,
                        RelativeSizeAxes = Axes.Both,
                        RimAction = KatsudonAction.P1_LeftRim.WithPlayerNo(player),
                        CentreAction = KatsudonAction.P1_LeftCentre.WithPlayerNo(player)
                    },
                    new KatsudonHalfDrum(true)
                    {
                        Name = "Right Half",
                        Anchor = Anchor.Centre,
                        Origin = Anchor.CentreLeft,
                        RelativeSizeAxes = Axes.Both,
                        RimAction = KatsudonAction.P1_RightRim.WithPlayerNo(player),
                        CentreAction = KatsudonAction.P1_RightCentre.WithPlayerNo(player)
                    },
        ...
        /// </summary>
        private partial class KatsudonHalfDrum : CompositeDrawable, IKeyBindingHandler<KatsudonAction>
        {
            /// <summary>
            /// The key to be used for the rim of the half-drum.
            /// </summary>
            public KatsudonAction RimAction;

            /// <summary>
            /// The key to be used for the centre of the half-drum.
            /// </summary>
            public KatsudonAction CentreAction;

            private readonly Drawable rimHit;
            private readonly Drawable centreHit;

            public KatsudonHalfDrum(bool flipped)
            {

...
namespace osu.Game.Rulesets.Katsudon.Skinning.Default
{
    public partial class DefaultInputDrum : AspectContainer
    {
            ...
            InternalChild = new Container
            {
                ...
                Children = new[]
                {
                    new KatsudonHalfDrum(false)
                    {
                        ...
                        X = -middle_split / 2,
                        RimAction = KatsudonAction.P1_LeftRim,
                        CentreAction = KatsudonAction.P1_LeftCentre
                    },
                    new KatsudonHalfDrum(true)
                    {
                        ...
                        RelativePositionAxes = Axes.X,
                        X = middle_split / 2,
                        RimAction = KatsudonAction.P1_RightRim,
                        CentreAction = KatsudonAction.P1_RightCentre
                    }
                }
            };
        }
        ...
        /// </summary>
        private partial class KatsudonHalfDrum : Container, IKeyBindingHandler<KatsudonAction>
        {
            /// <summary>

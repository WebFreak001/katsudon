...
namespace osu.Game.Rulesets.Katsudon.Skinning.Legacy
{
    ...
    internal partial class LegacyInputDrum : Container
    {
        ...
        private void load(ISkinSource skin)
        {
            ...
            const float negative_scale_adjust = KatsudonPlayfield.INPUT_DRUM_WIDTH / ratio;
        ...
        /// </summary>
        private partial class LegacyHalfDrum : Container, IKeyBindingHandler<KatsudonAction>
        {
            /// <summary>

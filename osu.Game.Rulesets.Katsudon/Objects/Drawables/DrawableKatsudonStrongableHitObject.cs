...
{
    public abstract partial class DrawableKatsudonStrongableHitObject<TObject, TStrongNestedObject> : DrawableKatsudonHitObject<TObject>
        where TObject : KatsudonStrongableHitObject
        where TStrongNestedObject : StrongNestedHitObject
    {
        ...
        protected DrawableKatsudonStrongableHitObject([CanBeNull] TObject hitObject)
            : base(hitObject)
        {
        ...
        protected override void AddNestedHitObject(DrawableHitObject hitObject)
        {
            ...
            foreach (var nested in NestedHitObjects)
                if (nested is DrawableKatsudonHitObject sub)
                    sub.HitObject.PlayerId = HitObject.PlayerId;
        ...
        /// This is only invoked if <see cref="KatsudonStrongableHitObject.IsStrong"/> is true for <see cref="HitObject"/>.
        /// </summary>

...
{
    public partial class DrawableDrumRoll : DrawableKatsudonStrongableHitObject<DrumRoll, DrumRoll.StrongNestedHit>
    {
        /// <summary>
        ...
        protected override void AddNestedHitObject(DrawableHitObject hitObject)
        {
            ...
            foreach (var nested in HitObject.NestedHitObjects)
                if (nested is KatsudonHitObject sub)
                    sub.PlayerId = HitObject.PlayerId;

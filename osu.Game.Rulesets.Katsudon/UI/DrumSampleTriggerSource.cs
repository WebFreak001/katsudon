...
namespace osu.Game.Rulesets.Katsudon.UI
{
    public partial class DrumSampleTriggerSource : GameplaySampleTriggerSource
    {
        ...
        public virtual void Play(Taiko.Objects.HitType hitType, bool strong)
        {
            ...
            var baseSample = hitObject.CreateHitSampleInfo(hitType == Taiko.Objects.HitType.Rim ? HitSampleInfo.HIT_CLAP : HitSampleInfo.HIT_NORMAL);
            ...
            if (strong)
            {
                ...
                {
                    baseSample,
                    hitObject.CreateHitSampleInfo(hitType == Taiko.Objects.HitType.Rim ? HitSampleInfo.HIT_WHISTLE : HitSampleInfo.HIT_FINISH)
                });
            }
            else
            {
